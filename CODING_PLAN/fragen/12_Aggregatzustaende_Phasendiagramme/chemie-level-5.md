# 🧪 Kapitel 12: Aggregatszustände & Phasendiagramme - Level 5
**Schwierigkeitsgrad:** Experte - Transfer & anspruchsvolle Problemlösung

---

## Frage 1
**Wasser hat mehrere Eismodifikationen (Eis I bis XIX). Was sagt das Phasendiagramm von Wasser bei hohen Drücken aus?**
...
## Frage 2
**Die Antoine-Gleichung log₁₀(P) = A - B/(C+T) ist genauer als Clausius-Clapeyron. Warum?**
...
## Frage 3
**Erkläre das Phänomen der Regelation bei Eis.**
...
## Frage 4
**Überkritisches Wasser (T > 374°C, P > 22,1 MPa) hat ungewöhnliche Eigenschaften. Welche?**
...
## Frage 5
**Das Phasendiagramm von Helium-4 zeigt bei sehr niedrigen Temperaturen eine superfluide Phase. Was bedeutet das?**
...
## Frage 6
**Ein geschlossener Behälter enthält flüssiges Wasser und Wasserdampf bei 25°C. Das System wird auf 200°C erhitzt. Beschreibe die Änderungen.**
...
## Frage 7
**Warum weicht Wasser so stark von der Trouton-Regel ab? (ΔSvap = 109 J/(mol·K) statt ~85)**
...
## Frage 8
**Ein Druckkochtopf arbeitet bei 2 atm. Berechne näherungsweise die Siedetemperatur von Wasser. (ΔHvap = 40,7 kJ/mol)**
...
## Frage 9
**Die Kelvin-Gleichung beschreibt den Dampfdruck über gekrümmten Oberflächen. Wie beeinflusst dies kleine Tröpfchen?**
...
## Frage 10
**Bei der Gefriertrocknung von Kaffee wird zuerst auf -40°C eingefroren, dann bei ~0,1 mbar vakuumiert. Erkläre den Prozess thermodynamisch.**
