# 🧪 Kapitel 8: Ionische Bindung & Lewis-Strukturen - Level 5
...
## Frage 1
**Berechne die Gitterenergie von CaF₂ mit der Born-Landé-Gleichung näherungsweise. Gegeben: A (Madelung) ≈ 2,52, r₀ = 237 pm, n = 8. Wie verhält sich der Wert zu NaCl?**

- [ ] A. CaF₂ hat etwa doppelt so hohe Gitterenergie wie NaCl
- [ ] B. CaF₂ und NaCl haben ähnliche Gitterenergien
- [ ] C. CaF₂ hat etwa dreimal so hohe Gitterenergie wie NaCl
- [ ] D. NaCl hat höhere Gitterenergie als CaF₂
...
## Frage 3
**Erkläre den Unterschied zwischen dem Born-Haber-Kreisprozess und der Born-Landé-Gleichung zur Bestimmung der Gitterenergie.**
...
## Frage 5
**Warum ist die Bindungsordnung im Benzol (C₆H₆) 1,5 und nicht 1 oder 2?**

- [ ] A. Resonanzstrukturen mit alternierenden Einzel- und Doppelbindungen
- [ ] B. Die tatsächliche Struktur ist ein Hybrid aller Resonanzformen
- [ ] C. Alle C-C-Bindungen sind äquivalent
- [ ] D. Die π-Elektronen sind delokalisiert
...
## Frage 7
**Das Thiosulfat-Ion (S₂O₃²⁻) hat eine ungewöhnliche Struktur. Welche Aussagen sind korrekt?**
...
## Frage 9
**Berechne mit dem Born-Haber-Kreisprozess die Gitterenergie von NaCl. Gegeben: ΔH_f(NaCl) = -411 kJ/mol, ΔH_sub(Na) = 108 kJ/mol, IE(Na) = 496 kJ/mol, ½ D(Cl₂) = 122 kJ/mol, EA(Cl) = -349 kJ/mol**
